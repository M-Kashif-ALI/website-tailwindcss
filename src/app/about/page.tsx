...
const About = () => {
  return (
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 min-h-screen text-white px-28 py-20 flex flex-col items-center justify-center h-full w-full">
      <h1 className="text-center text-5xl font-serif font-bold">About</h1>
